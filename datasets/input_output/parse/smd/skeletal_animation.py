...
def split_array(content, fn):
    ...
    while cursor < len(content):
        ...
        for end in range(cursor + 1, len(content) + 1):
            if end >= len(content) or fn(content[end]): break
